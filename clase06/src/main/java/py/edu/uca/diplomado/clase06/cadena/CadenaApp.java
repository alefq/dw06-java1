package py.edu.uca.diplomado.clase06.cadena;
...
//			System.out.println(datos[i]);
	...
	private static void pruebaInmutabilidad() {
		...
		/*
		 * La clase StringBuffer se estudiará más adelante. Basta saber que se
		 * emplea para almacenar cadenas de texto que cambian con mucha
		 * frecuencia. Se introduce para comprobar que sólo las Strings son
		 * inmutables, no el resto de objetos.
		 */
